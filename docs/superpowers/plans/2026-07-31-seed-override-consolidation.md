...
- [x] **Step 4: Rewrite `ExerciseSeedExpansion.kt`**
...
- [x] **Step 6: Confirm module still compiles**
...
- [x] **Step 1: Survey the callers that will change**
...
- [x] **Step 2: Change `ReplayEngine.runCore` to `SeedBelief`**
...
- [x] **Step 3: Change `ReplayEngine.run` to source seeds live**
...
- [x] **Step 4: Change `ExerciseProgressionSeriesBuilder` to match**
...
- [x] **Step 5: Bump `WorkoutBackup.DB_VERSION` to 19 so the local fixture loads**
...
- [x] **Step 6: Switch `BacktestData` to live expansion**
...
- [x] **Step 7: Run the replay/backtest unit tests (pre-repin)**
...
- [x] **Step 8: Run the pinned gate and read the new number**
...
- [x] **Step 9: Re-pin to the measured value (HUMAN CHECKPOINT)**
...
- [x] **Step 1: Find existing coverage + call sites**
...
- [x] **Step 2: Delete the durable write**
...
- [x] **Step 3: Update/remove now-invalid tests**
...
- [x] **Step 4: Run the affected tests + compile**
...
- [x] **Step 1: Write the failing instrumented migration test**
...
- [x] **Step 4: Delete the entity, DAO, and their wiring**
...
- [x] **Step 5: Simplify `seedInitialWeights` and clean remaining refs**
...
- [x] **Step 6: Drop the table + flag from backup**
...
- [x] **Step 7: Run to verify pass — unit + the new migration test**
...
- [x] **Step 5: Whole-branch code review**
