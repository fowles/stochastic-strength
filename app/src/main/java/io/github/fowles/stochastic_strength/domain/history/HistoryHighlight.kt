...
object HistoryHighlight {
    ...
    val QUIPS: List<Quip> = listOf(
        ...
        Quip("Diesel Fibonacci added the last two sets and got a bigger one."),
        ...
        Quip("Buff Pascal ran the numbers. They favor the one who showed up."),
        Quip("Jacked Ada Lovelace wrote the first algorithm. Yours is: sleep, eat, lift, repeat."),
        Quip("Massive Marie Curie discovered two elements. You discovered a third: pure iron."),
        ...
        Quip("Diesel Descartes: I lift, therefore I am."),
        ...
        Quip("Diesel Avogadro counted your reps. Approximately 6.022 x 10^23, give or take."),
        Quip("The foam roller forgives all sins."),
        Quip("Ripped Ramanujan saw the pattern in a dream. The pattern was: more plates."),
        ...
        Quip("Jacked Gauss summed 1 to 100 instantly. You'll sum 100 reps eventually. Same energy."),
        Quip("The hardest lift is the front door of the gym. You cleared it."),
        Quip("Diesel da Vinci sketched the perfect proportions. You're editing his draft."),
        Quip("Rest is not a reward, it's a requirement. Diesel Boltzmann insists."),
        Quip("Your grip strength is applying for its own zip code."),
        Quip("Buff Hypatia mapped the stars. You're mapping a constellation of PRs."),
        ...
        Quip("Diesel Atlas held up the sky. You're just holding the row.", muscle = MuscleGroup.BACK),
        ...
        Quip("Diesel Sisyphus finally reached the top. Turns out it was calf raises.", muscle = MuscleGroup.CALVES),
