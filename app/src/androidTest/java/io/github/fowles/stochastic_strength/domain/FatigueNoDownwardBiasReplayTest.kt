...
class FatigueNoDownwardBiasReplayTest {
    ...
    companion object {
         ...
         * assumed by this test will silently diverge, potentially altering the 1RM estimate implied
         * by the belief fold and producing unexpected coefficient proposals.
         *
