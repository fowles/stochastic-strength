...
1. **HURT** is muscle-level: any `HURT` set hurts every loaded exercise estimate in that muscle (`ExerciseEstimateUpdater.hurt` multiplies the estimate by `hurtFactor` = 0.85).
